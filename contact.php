...
<html lang="zxx">
    <head>
        ...
        <meta property="og:description" content="Travel Arcade">
    ...
    <body>
                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav mx-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="contact.php" class="nav-link " style="background-color: #6b52a3 ;color: white; " onmouseover="this.style.color='black'" onmouseout ="this.style.color='white'">Contact</a>
                                    </li>
        ...
        <!-- Header -->
        <!-- Contact -->
        <div class="contact-section pt-100 pb-70 position-relative" id="contact-area">
        <?php print_r($msg); ?>
                    ...
                    <div class="col-sm-6 col-lg-4 pb-30">
                        <div class="contact-info-item desk-pad-right-10">
                            ...
                            <ul>
                                <li>
                                    <i class="flaticon-mail"></i>
                                    <a href="mailto:info@travelarcades.com">info@travelarcades.com</a>
                                </li>
                                <li>
                                    <i class="flaticon-telephone"></i>
                                    <a href="tel:+94 11 259 1290">(+94) 11 259 1290</a>
                                ...
                                <li>
                                    <i class="flaticon-telephone"></i>
                                    <a href="tel:+94 11 259 1291">(+94) 11 259 1291</a>
                                </li>
                                <li>
                                    <i class="flaticon-telephone"></i>
                                    <a href="tel:+94 11 259 1292">(+94) 11 259 1292</a>
                                </li>
                                <li>
                                    <i class="flaticon-address"></i>
                                    No. 15, Police Park Avenue, Colombo 5, Sri Lanka.
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="contact-map-iframe mb-100">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.9723179702196!2d79.85758197377164!3d6.893914518750566!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25bd9969e25c9%3A0xb34a12b8fc591226!2sTravel%20Arcade!5e0!3m2!1sen!2slk!4v1693478383170!5m2!1sen!2slk"></iframe>
        </div>
        <!-- Iframe -->
        <!-- Footer -->
