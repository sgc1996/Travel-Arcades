jQuery(function ($) {
    ...
    popularCarousel.on('autoplay', '.owl-stage', function (e) {
     ...
     // air-ticket-logo carousel
     $(".air-ticket-logo").owlCarousel({
        items: 4,
        loop: true,
        dots: false,
        dotsEach: 3,
    ...
    $(".testimonial-carousel").owlCarousel({
        ...
        smartSpeed: 1500,
        autoplay: true, // Enable auto-sliding
        autoplayTimeout: 6000, // Set the autoplay interval (in milliseconds), adjust as needed
        responsive:{
            0: {
                items: 1,
                margin: 20
