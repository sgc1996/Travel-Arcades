...
<html lang="zxx">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    <a href="visa.php" class="nav-link"  style="background-color: #6b52a3 ;color: white; " onmouseover="this.style.color='black'" onmouseout ="this.style.color='white'">Visa</a>
            ...
            <div class="row lign-items-lg-start">
                <div class="col-lg-6 pb-30">
                    <div class="about-content-details desk-pad-right-40">
                        <p>We understand that obtaining a visa can often be a complex and time-consuming process. That's why we are here to simplify your visa application experience and make your travel dreams a reality.</p>
                        <p>Travel Arcade (Pvt) Ltd is a trusted and dedicated visa service provider, committed to assisting travelers in obtaining the necessary visas for their international journeys. We aim to empower travelers by providing expert guidance, thorough documentation review and personalized support throughout the visa application process. We believe that everyone should have the opportunity to explore the world, and we are here to make that journey possible.</p>
                    </div>
                </div>
                <div class="col-lg-6 pb-30">
                    <div class="about-content-image border-radius-10">
                        <img src="assets/images/visa-description.jpg" alt="Visa">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 pb-30 pt-30">
                    <div class="about-selection-content">
                        <ul class="about-selection-list">
                            <li class="active" data-about-list="1">Our Services</li>
                            <li data-about-list="2">Why Choose Us</li>
                        </ul>
                        <div class="about-selection-details">
                            <div class="about-selection-details-item active" data-about-details="1">
                                <div class="forum-details">
                                    <ul>
                                        <li>Tourist Visas: Whether you're planning a relaxing getaway or an adventurous journey, we can assist you in securing the tourist visa you need.</li>
                                        <li>Business Visas: For business travelers seeking to explore global opportunities, we provide efficient visa solutions to facilitate your ventures.</li>
                                        <li>Family Visitor Visa: Whether you're reuniting with loved ones or celebrating special occasions, we can assist you in securing the family visitor visa you need for a memorable family gathering.</li>
                                        <li>At Travel Arcade (Pvt) Ltd, we believe that the world is meant to be explored. Let us handle the visa application process, so you can focus on creating unforgettable memories during your travels.</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="about-selection-details-item" data-about-details="2">
                                <div class="forum-details">
                                    <ul>
                                        <li>Our team of visa experts is well-versed in the intricacies of visa regulations for various countries. We stay updated with the latest changes in visa requirements to ensure your application is accurate and compliant.</li>
                                        <li>We understand that every traveler is unique. That's why we provide personalized assistance tailored to your specific needs and travel plans. Your journey is our priority.</li>
                                        <li>Have questions or concerns? Our dedicated customer support team is here to assist you at every step. We are just a phone call or email away.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <div class="contact-section pt-70 pb-70 position-relative">
        ...
        <div class="container">
            <div class="row mb-30">
                <div class="col-lg-6 pb-30">
                    <div class="contact-grid-item contact-grid-bg-1"></div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 pb-30">
                    <div class="contact-info-item desk-pad-left-10 desk-pad-right-10">
                        ...
                        <div class="forum-details">
                            <ul>
                                <li>Travel with peace. Our insurance options protect from unexpected events.</li>
                                <li>Our travel insurance considers trip length, activities, and risks for suitable protection.</li>
                                <li>Insurance covers emergencies, medical needs, and unexpected incidents during travel.</li>
                            </ul>
                        </div>
                    </div>
                </div>
