...
<html lang="zxx">
    ...
    <body>
                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav mx-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="inbound-tours.php" class="nav-link  " onmouseover="this.style.color='black'" onmouseout ="this.style.color='white'">Sri Lanka</a>
        ...
        <!-- Navbar -->
        <!-- Header -->
        <header class="inner-category-page-header inner-page-header-1">
        ...
        <?php print_r($msg); ?>
            ...
            <div class="container">
                <div class="section-title section-title-lg">
                    ...
                    <h2>Sri Lanka Adventure Tours</h2>
                </div>
                <div class="row">
        ...
        <section class="destination-section pb-100">
            <div class="container">
                <div class="section-title">
                    <!-- <small>Outbound Tour Packages</small> -->
                    <h2>World Adventure Tours</h2>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                <img src="assets/images/outbound-tours/dubai/dubai-page.jpg" alt="Dubai">
                                <h3 class="destination-card-name">Dubai</h3>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                ...
                                <h3 class="destination-card-name">Indonesia</h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                ...
                                <h3 class="destination-card-name">Malaysia </h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                <img src="assets/images/outbound-tours/india/india-page.jpg" alt="India (Shimla & Manali)">
                                <h3 class="destination-card-name">India (Shimla & Manali)</h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                <img src="assets/images/outbound-tours/singapore/singapore-page.jpg" alt="Singapore">
                                <h3 class="destination-card-name">Singapore</h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                <img src="assets/images/outbound-tours/thailand/thailand-page.jpg" alt="Thailand">
                                <h3 class="destination-card-name">Thailand</h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                <img src="assets/images/outbound-tours/vietnam/vietnam-page.jpg" alt="Vietnam">
                                <h3 class="destination-card-name">Vietnam</h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                <img src="assets/images/outbound-tours/athens/athens-page.jpg" alt="Athens">
                                <h3 class="destination-card-name">Athens</h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 pb-30">
                        <div class="destination-card-full">
                            <div class="destination-card-image">
                                <img src="assets/images/outbound-tours/azerbaijan/azerbaijan-page.jpg" alt="Azerbaijan">
                                <h3 class="destination-card-name">Azerbaijan</h3>
                            </div>
                            <div class="card-1-content">
                                <div class="card-1-info">
                                    <ul class="card-2-entry">
