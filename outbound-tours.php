...
<html lang="zxx">
    ...
    <body>
                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav mx-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="outbound-tours.php" class="nav-link " style="background-color: #6b52a3 ;color: white; " onmouseover="this.style.color='black'" onmouseout ="this.style.color='white'">World Tours</a>
                ...
                <div class="header-content m-auto">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">World Tour</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <?php print_r($msg); ?>
            ...
            <div class="container">
                <div class="section-title">
                    <small>Outbound Tours</small>
                    <h2>Beautiful World</h2>
                </div>
                <div class="row lign-items-lg-start">
                    <div class="col-lg-6 pb-30">
                        <div class="about-content-details desk-pad-right-40">
                            <p>Travel Arcade is a distinguished travel agency with a network of reputable agents worldwide, built on trust and mutual understanding. This network offers clients remarkable travel opportunities to popular destinations. They pride themselves on being a one-stop travel solution, handling everything from hotel bookings to transportation and tours. Their experienced professionals tailor travel experiences to individual preferences, ensuring a seamless journey.</p>
                            <p>Travel Arcade's commitment to detail provides peace of mind, and their diverse portfolio includes cruise packages and family vacations. They transform travel aspirations into cherished memories, allowing clients to fully enjoy their trips while the agency manages logistics. Choosing Travel Arcade means selecting a dedicated travel partner for unforgettable experiences.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 pb-30">
                        <div class="about-content-image border-radius-10">
                            <img src="assets/images/outbound-tours/description.jpg" alt="Outbound Tours">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- World Tours -->
        <section class="destination-section pb-100" style="margin-top: 3em;">
            <div class="container">
                <div class="section-title">
